  ...
  return (
    <div className="mt-12">
      ...
      <div className="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
        <Card className="overflow-hidden xl:col-span-2 bg-[#373C40]">
          <CardHeader
            floated={false}
            shadow={false}
            color="transparent"
          ...
          >
            <div>
              <Typography variant="h6" color="blue" className="mb-1 font-bold text-[24px]">
                Projects
              </Typography>
              <Typography
                variant="small"
        ...
        <Card className="bg-[#373C40]">
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="m-0 p-6 border-b border-white border-opacity-50"
          >
